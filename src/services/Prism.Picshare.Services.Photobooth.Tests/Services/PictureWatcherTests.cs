...
public class PictureWatcherTests
{
    ...
    public async Task ProcessPictureAsync_Ok()
    {
        ...
        // Assert
        daprClient.Verify(x => x.PublishEventAsync(DaprConfiguration.Photobooth.InternalPubSub, Topics.Photobooth.PictureTaken, It.IsAny<PhotoboothPicture>(), It.IsAny<CancellationToken>()), Times.Once);
