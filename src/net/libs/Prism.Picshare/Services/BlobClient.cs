...
public abstract class BlobClient
{
    ...
    public abstract Task DeleteAsync(string blobName, CancellationToken cancellationToken = default);
    public abstract Task<List<string>> ListAsync(Guid organisationId, CancellationToken cancellationToken = default);
    public abstract Task<List<string>> ListAsync(Guid organisationId, Guid pictureId, CancellationToken cancellationToken = default);
