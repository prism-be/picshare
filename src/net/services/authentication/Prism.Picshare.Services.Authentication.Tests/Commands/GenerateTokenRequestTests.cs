...
public class GenerateTokenRequestTests
{
    ...
    public async Task Handle_Credentials_Not_Found()
    {
        ...
        // Act
        var handler = new GenerateTokenRequestHandler(logger.Object, daprClient.Object, config);
    ...
    public async Task Handle_Ok()
    {
        ...
        ValidateToken(config.PublicKey, result.AccessToken).Should().BeTrue();
        ValidateToken(config.PublicKey, result.RefreshToken).Should().BeTrue();
    }
